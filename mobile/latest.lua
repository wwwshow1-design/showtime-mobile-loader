...
QueueListPadding.PaddingBottom = UDim.new(0, 3)
...
EnableCardScrollSnap(List, UserInputService.TouchEnabled and 104 or 78)
...
Title.BackgroundTransparency = 1
Title.Text = "쇼타임 통합 자동팜 V3.8 모바일 시험본"
Title.TextColor3 = Color3.fromRGB(245, 245, 245)
Title.TextSize = 17
Title.Font = Enum.Font.GothamBold
Title.TextXAlignment = Enum.TextXAlignment.Left
...
UI.Title.Text = "쇼타임 통합 자동팜 V3.8 모바일 시험본"
